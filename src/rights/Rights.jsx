...
const Rights = () => {
  const sections = [
    {
      title: "سياسة السلامة وإدارة المخاطر",
      items: [
        {
          label: "بيئة آمنة",
          text: "توفير بيئة تأهيلية آمنة تلتزم بمعايير الصحة والسلامة المهنية العالمية والمحلية.",
        },
        {
          label: "تقييم المخاطر",
          text: "إجراء فحص دوري للمرافق واتخاذ إجراءات وقائية استباقية لضمان سلامة الجميع.",
        },
        {
          label: "الاستجابة للطوارئ",
          text: "تدريب الفريق على بروتوكولات التعامل مع الحالات الطارئة بطريقة مهنية ومنظمة.",
        },
      ],
    },
  ];
  ...
  return (
    <main className="min-h-screen pb-20 bg-white">
      <PageHeader title="حقوق المستفيدين" currentPath="/rights" />
        ...
        <div className="space-y-12 text-right">
          <div className="p-8 border-r-4 bg-gray-50 border-green-700/30 rounded-l-xl">
            <p className="text-xl font-medium leading-relaxed text-gray-900">
              توفير بيئة تأهيلية آمنة لجميع المستفيدين والموظفين.
            </p>
          </div>
